...
import tr.org.liderahenk.wol.dialogs.WolProfileDialog;
...
/**
 * Profile definition handler for wol plugin.
 *
 */
public class WolProfileHandler extends AbstractHandler {

	private Logger logger = LoggerFactory.getLogger(WolProfileHandler.class);
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        try {
			...
			page.openEditor(new ProfileEditorInput(Messages.getString("Wol"), WolConstants.PLUGIN_NAME, 
					WolConstants.PLUGIN_VERSION, new WolProfileDialog()), 
